...
export function Tasks() {
  ...
  useEffect(() => {
    const fetchTasks = async () => {
      ...
      try {
        const response = await axios.get('https://leadsavvyai.com/api/tasks', { headers });
  ...
  const handleAddTask = async (e) => {
    ...
    try {
      const response = await axios.post('https://leadsavvyai.com/api/tasks', newTask, { headers });
  ...
  const handleDeleteTask = async (taskId) => {
    ...
    try {
      await axios.delete(`https://leadsavvyai.com/api/tasks/${taskId}`, { headers });
