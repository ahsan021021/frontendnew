...
export function Contacts() {
  ...
  useEffect(() => {
    const fetchContacts = async () => {
      try {
        ...
        const response = await axios.get("https://leadsavvyai.com/api/contacts", {
  ...
  const handleAddContact = async (e) => {
    ...
    try {
      const token = getToken();
      const response = await axios.post("https://leadsavvyai.com/api/contacts", newContact, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const handleDeleteContact = async (id) => {
    try {
      const token = getToken();
      await axios.delete(`https://leadsavvyai.com/api/contacts/${id}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
    ...
    try {
      ...
      await Promise.all(
        selectedContacts.map((id) =>
          axios.delete(`https://leadsavvyai.com/api/contacts/${id}`, {
            headers: { Authorization: `Bearer ${token}` },
          })
        )
      );
